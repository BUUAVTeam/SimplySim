...
<ComplexObject xmlns="http://www.simplysim.net/2009/12/datamodel.xsd">
  <Element Name="Body" Class="Actor" Type="drone2_files\drone2body">
    <Translation />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
  </Element>
  <Element Name="FrontLeftBladeUp" Class="Actor" Type="common_files\righthandedblade">
    <Translation X="0.28" Y="0.045" Z="-0.16" />
    <Rotation>
      <Quaternion W="0.866" Y="-0.5" />
    </Rotation>
  </Element>
  <Element Name="FrontLeftBladeDown" Class="Actor" Type="common_files\lefthandedblade">
    <Translation X="0.28" Y="-0.045" Z="-0.16" />
    <Rotation>
      <Quaternion X="0.9659258" Z="-0.258819073" />
    </Rotation>
  </Element>
  <Element Name="FrontRightBladeUp" Class="Actor" Type="common_files\righthandedblade">
    <Translation X="-0.28" Y="0.045" Z="-0.16" />
    <Rotation>
      <Quaternion W="0.8660254" Y="0.5" />
    </Rotation>
  </Element>
  <Element Name="FrontRightBladeDown" Class="Actor" Type="common_files\lefthandedblade">
    <Translation X="-0.28" Y="-0.045" Z="-0.16" />
    <Rotation>
      <Quaternion X="0.707106769" Z="0.707106769" />
    </Rotation>
  </Element>
  <Element Name="RearBladeUp" Class="Actor" Type="common_files\righthandedblade">
    <Translation Y="0.045" Z="0.32" />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
  </Element>
  <Element Name="RearBladeDown" Class="Actor" Type="common_files\lefthandedblade">
    <Translation Y="-0.045" Z="0.32" />
    <Rotation>
      <Quaternion X="0.9659258" Z="0.258819073" />
    </Rotation>
