...
<ComplexObject xmlns="http://www.simplysim.net/2009/12/datamodel.xsd">
  <Element Name="Body" Class="Actor" Type="drone3_files\drone3body">
    <Translation />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
  </Element>
  <Element Name="FrontBlade" Class="Actor" Type="common_files\righthandedblade">
    <Translation Y="0.045" Z="-0.42" />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
  </Element>
  <Element Name="FrontRightBlade" Class="Actor" Type="common_files\lefthandedblade">
  ...
  <Element Name="FrontLeftBlade" Class="Actor" Type="common_files\lefthandedblade">
    <Translation X="0.365" Y="0.045" Z="-0.21" />
    <Rotation>
      <Quaternion W="0.258819073" Y="-0.9659258" />
    </Rotation>
  </Element>
  <Element Name="RearLeftBlade" Class="Actor" Type="common_files\righthandedblade">
    <Translation X="0.365" Y="0.045" Z="0.21" />
    <Rotation>
      <Quaternion W="0.8660254" Y="0.5" />
    </Rotation>
  </Element>
  <Element Name="RearRightBlade" Class="Actor" Type="common_files\righthandedblade">
    <Translation X="-0.365" Y="0.045" Z="0.21" />
    <Rotation>
      <Quaternion W="0.8660254" Y="-0.5" />
    </Rotation>
