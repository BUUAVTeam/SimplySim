...
<ComplexObject xmlns="http://www.simplysim.net/2009/12/datamodel.xsd">
  <Element Name="Body" Class="Actor" Type="drone1body">
    <Translation />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
  </Element>
  <Element Name="LeftBlade" Class="Actor" Type="righthandedblade">
    <Translation X="0.29" Y="0.045" />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
  </Element>
  <Element Name="RightBlade" Class="Actor" Type="righthandedblade">
    <Translation X="-0.29" Y="0.045" />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
  ...
  <Element Name="FrontBlade" Class="Actor" Type="lefthandedblade">
    <Translation Y="0.045" Z="-0.29" />
    <Rotation>
      <Quaternion W="1" />
    </Rotation>
